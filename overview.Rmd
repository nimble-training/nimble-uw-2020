---
title: "NIMBLE UW Workshop"
subtitle: "NIMBLE short course"
...
The Github site ([https://github.com/nimble-training/nimble-uw-2020](https://github.com/nimble-training/nimble-uw-2020)) is the master repository for materials for the modules; you can also get the individual files from Github. 

If you're not familiar with Git, you can get these materials by simply going to [https://github.com/nimble-training/nimble-uw-2020](https://github.com/nimble-training/nimble-uw-2020) and click on the 'Download ZIP' button in the right side of the window or simply click [here](https://github.com/nimble-training/nimble-uw-2020/archive/master.zip). See also slide 6 in this document for how to get them using Git or from within RStudio.
...
Simply go to [https://github.com/nimble-training/nimble-uw-2020](https://github.com/nimble-training/nimble-uw-2020) and click on the 'Download ZIP' button in the right side of the window or simply click [here](https://github.com/nimble-training/nimble-uw-2020/archive/master.zip).

## Within RStudio

Within RStudio go to File->New Project->Version Control->Git and enter:

- "Repository URL": https://github.com/nimble-training/nimble-uw-2020
- "Project Directory Name": nimble-uw-2020 (or something else of your choosing)
...
- `git clone https://github.com/nimble-training/nimble-uw-2020`

Then to update from the repository to get any changes we've made:

- `cd /directory/where/you/put/the/repository/nimble-uw-2020`
- `git pull`
...
Here are the modules we'll work through for this short course.
 ...
 - Introduction to NIMBLE (45 minutes)
    ...
    2. [Basic NIMBLE usage](modules/2_basic_use_slides.html)
    3. [NIMBLE's dialect of BUGS](modules/3_nimble_bugs_slides.html)

 - Customizing an MCMC and advanced model building (75 minutes)

    4. [MCMC concepts](modules/4_mcmc_concepts_slides.html) 
    5. [Customizing an MCMC](modules/5_customizing_mcmc_slides.html)
    6. [Variable selection via reversible jump](modules/6_variable_selection_slides.html)
 ...
 - Programming algorithms in NIMBLE (90 minutes)
 
    9. [Using and programming with models](modules/9_using_models_slides.html)
    10. [Writing your own MCMC sampler](modules/10_user_sampler_slides.html) 
    11. [Wrap up: participant models/discussion, calling external code, gradients/HMC, and more](modules/11_wrapup_slides.html)
